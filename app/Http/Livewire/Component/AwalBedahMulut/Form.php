...
namespace App\Http\Livewire\Component\AwalBedahMulut;
...
class Form extends Component
{
    ...
    protected $listeners = ['hapusMedisRalanBedahMulut' => 'hapus'];
    ...
    {
        return view('livewire.component.awal-bedah-mulut.form');
    }
    ...
    public function updatedNoRawat()
    {
        try {
            $this->resetInput();
            $data = DB::table('penilaian_medis_ralan_bedah_mulut')
    ...
    public function simpan()
    {
        ...
        try {
            if ($this->editMode) {
                DB::table('penilaian_medis_ralan_bedah_mulut')
                    ->where('no_rawat', $this->no_rawat)
                    ->update(Arr::except($data, ['no_rawat', 'kd_dokter']));

                $this->alert('success', 'Data berhasil diubah');
            } else {
                DB::table('penilaian_medis_ralan_bedah_mulut')->insert($data);
        ...
        try {
            ...
            if ($data) {
                $this->confirm('Apakah anda yakin ingin menghapus data ini?', [
                    'onConfirmed'       => 'hapusMedisRalanBedahMulut',
