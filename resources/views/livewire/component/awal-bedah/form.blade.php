    ...
    <form wire:submit.prevent='simpan'>
        ...
        <div class="row">
            <div class="col-6 col-md-6">
                <x-ui.input-datetime label="Tanggal" id="tanggal_bedah" model="tanggal" />
            </div>
            <div class="col-6 col-md-6">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <x-ui.input label="Status / Keadaan Umum" id="status" model="status" />
            </div>
            <div class="col-md-4">
                <x-ui.input label="GCS" id="gcs" model="gcs" />
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <x-ui.input label="Nadi (x/mnt)" id="nadi" model="nadi" />
            </div>
            <div class="col-md-3">
                <x-ui.input label="Suhu (°C)" id="suhu" model="suhu" />
            </div>
            <div class="col-md-3">
                <x-ui.input label="RR (x/mnt)" id="rr" model="rr" />
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <x-ui.input label="Nyeri (NRS 0-10)" id="nyeri" model="nyeri" />
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-6">
                <x-ui.select :label="$field['label']" :id="$field['id']" :model="$field['id']">
        ...
        <div class="row">
            <div class="col-12">
                <x-ui.textarea label="Keterangan Pemeriksaan Fisik Lainnya" id="lainnya" model="lainnya" />
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <x-ui.textarea label="Keterangan Status Lokalis" id="ket_lokalis" model="ket_lokalis" />
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <x-ui.textarea label="Pemeriksaan Lain" id="pemeriksaan" model="pemeriksaan" />
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <x-ui.textarea label="Diagnosis Kerja" id="diagnosis" model="diagnosis" />
            </div>
            <div class="col-md-6">
                <x-ui.textarea label="Diagnosis Banding" id="diagnosis2" model="diagnosis2" />
            </div>
        </div>
...
@push('js')
<script>
    $(".btn-awal-bedah").on('click', function () {
        var id = $(this).attr('id');
        @this.set('no_rawat', id);
        $("#modal-awal-medis-bedah").modal('show');
    });
</script>
@endpush
