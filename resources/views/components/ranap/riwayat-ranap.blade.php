                ...
                <div class="timeline-item">
                    ...
                    <div class="timeline-body">
                        ...
                        @include('partials.riwayat-tambahan', [
                            'ctrl'     => \App\Http\Controllers\Ranap\PemeriksaanRanapController::class,
...
<script>
    $(document).on('click', '[data-toggle="lightbox"]', function(event) {
        ...
        function formatStudyDateRanap(d) {
            if (!d || d.length < 8) return d || '-';
            return d.slice(6,8) + '-' + d.slice(4,6) + '-' + d.slice(0,4);
        }

        function loadOrthancGalleryRanap($container) {
            ...
            $.getJSON('/api/orthanc/studies/' + encodeURIComponent(noRm))
                .done(function(res) {
                    ...
                    res.studies.forEach(function(study) {
                        ...
                        html += '<div><b>' + formatStudyDateRanap(study.study_date) + '</b> <span class="text-muted">' + (study.accession || '') + '</span></div>';
                        ...
                        study.series.forEach(function(s) {
                            ...
                            s.instances.forEach(function(iid) {
                                ...
                                html += '<a href="' + preview + '" data-toggle="lightbox" data-gallery="orthanc-ranap-' + study.id + '">';
        ...
        $(document).on('shown.bs.modal', '#modalRiwayatPemeriksaanRanap', function() {
            $(this).find('[data-orthanc-gallery]').each(function() {
                loadOrthancGalleryRanap($(this));
            });
        });
